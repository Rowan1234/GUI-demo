...
public class UIMainWorld extends World
{
    ...
    private void testActors()
    {
         ...
         *          you want
         */
        Label label = new Label("THANOS IS COMING",40);
         ...
         */
        TextBox textBox = new TextBox("It's time to get jiggy with it", 24, true, Color.WHITE, Color.BLACK);
         ...
         */
        Menu menu = new Menu("File", "New/Open/Save/Close/Exit", 18, Color.BLACK, Color.WHITE, Color.BLACK, Color.WHITE, new FileCommands());
