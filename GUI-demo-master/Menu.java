...
public class Menu extends Actor
{
     ...
     *              
     *              //Make a method call to the execute method of the menuCommands variable. The execute method will require the 
     *              menuIndex variable and the getWorld() method as parameters
     *              
     ...
     */
     private void handleMouse()
     {
         ...
         if (Greenfoot.mouseClicked(this))
         {
            if(visible == false)
            {
                getWorld().addObject(menuItems,30,30);//change
            }
